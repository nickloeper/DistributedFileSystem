...
public class BootupUpdate implements Runnable {
	...
	public BootupUpdate(MutableBoolean isPrimary, InetAddress frontendIP, HashMap<String, Integer> fileList, InetAddress rm1IP, InetAddress rm3IP) throws Exception {
	...
	private void sendList() {
		ClientDataSerializer mySer = new ClientDataSerializer();
		try {
			UnicastUtilities sendList = new UnicastUtilities(6502);
	...
	private void streamFiles() {
		...
		try {
			receiveNeededFiles = new UnicastUtilities(6502);
